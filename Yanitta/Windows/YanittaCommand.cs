...
namespace Yanitta
{
    public class YanittaCommand : RoutedUICommand
    {
        ...
        public static RoutedUICommand AddProfile { get; private set; }

        public static RoutedUICommand CopyProfile { get; private set; }

        public static RoutedUICommand DeleteProfile { get; private set; }

        public static RoutedUICommand SaveProfileLua { get; private set; }
        ...
        static YanittaCommand()
        {
            ...
            AddProfile = NewCommand("AddProfile");
            CopyProfile = NewCommand("CopyProfile");
            DeleteProfile = NewCommand("DeleteProfile");
            SaveProfileLua = NewCommand("SaveProfileLua");
