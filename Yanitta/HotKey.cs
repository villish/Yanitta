...
namespace Yanitta
{
    ...
    public class HotKey : IMessageFilter, IDisposable
    {
        ...
        public override string ToString()
        {
            ...
            string prefix = this.Modifiers.ToString();
            string name   = Enum.GetName(typeof(Keys), this.KeyCode);

            if (this.Modifiers != KeyModifiers.None)
        ...
        public static HotKey Parse(string str)
        {
            ...
            var allModifiers = (KeyModifiers[])Enum.GetValues(typeof(KeyModifiers));
            ...
            foreach (var keyName in strKeys)
            {
                ...
                {
                    // modifier
                    if (keyName.Equals(modifier.ToString()))
                    {
                        modifiers |= modifier;
                        break;
                    }
                    ...
                    {
                        if (!Enum.TryParse<Keys>(keyName, true, out key))
                            return new HotKey();
                    }
                }
            } 
